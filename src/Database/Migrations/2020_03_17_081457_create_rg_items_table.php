...
class CreateRgItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('tenant')->create('rg_items', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('selling_financial_account_code')->nullable(); //Sales revenue
            ...
            $table->unsignedBigInteger('billing_financial_account_code')->nullable(); //Cost of Sales
