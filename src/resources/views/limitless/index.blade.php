...
@section('content')
    ...
    <div class="navbar navbar-default navbar-lg rg_datatable_onselect_btns p-10" id="navbar-second">
        ...
        <div class="navbar-collapse collapse p-10" id="navbar-second-toggle">
            <ul class="nav navbar-nav">
                <li class="active"><button type="button" class="btn btn-link rg_datatable_selected_activate text-success" data-url="{{url('items/activate')}}"><i class="icon-info22 position-left"></i> Activate</button></li>
                <li class="active"><button type="button" class="btn btn-link rg_datatable_selected_deactivate text-warning" data-url="{{url('items/deactivate')}}"><i class="icon-alert position-left"></i> Deactivate</button></li>
                <li class="active"><button type="button" class="btn btn-link rg_datatable_selected_delete text-danger" data-url="{{url('items/delete')}}"><i class="icon-bin position-left"></i> Delete</button></li>
            </ul>
        </div>
    </div>
    <!-- /second navbar -->
        ...
        <div class="page-header-content">
            <div class="page-title clearfix">
                ...
                <div class="pull-right">
                    <button type="button" class="btn btn-danger btn-labeled pr-20" data-href="{{route('items.create')}}"><b><i class="icon-plus22"></i></b> New Item </button>

                    <div class="btn-group btn-xs btn-group-animated no-padding mr-20">
                        <button type="button" class="btn btn-danger btn-labeled pr-20 import_btn" data-import="items" data-url="{{url('items/import')}}">
    ...
    <div class="content no-padding-left no-padding-right">
        ...
        <div class="panel panel-flat no-border no-shadow">
            ...
            <table class="rg-datatable  table datatable-pagination no-border-top" data-ajax="{{route('items.datatables')}}">
                <thead>
                <tr>
