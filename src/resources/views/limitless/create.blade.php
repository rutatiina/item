                ...
                <div class="page-title clearfix">
                    ...
                    <div class="pull-right">
                        ...
                        <div class="btn-group btn-xs btn-group-animated no-padding mr-20">
                            <button type="button" class="btn btn-danger btn-labeled pr-20 import_btn" class="label bg-blue-400" data-import="items" data-url="{{url('items/import')}}">
                        ...
                        <div class="col-md-7">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="name" value="" class="form-control input-roundless"
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" name="sku" value="" class="form-control input-roundless"
                                ...
                                <div id="track_inventory" class="form-group clearfix" style="line-height: 35px;">
                                    ...
                                    <div class="col-lg-2 {{--border-right border-grey-300--}}">
                                        <input type="text" name="units" value="1" class="form-control input-roundless"
                                               placeholder="Units">
                                    </div>
                                    <div class="col-lg-8">
                        ...
                        <div id="item_rates" class="form-group col-md-7 {{$info_class}}">
                            ...
                            <div id="item_sales_info" class="col-md-6">
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="selling_rate" value=""
                                        ...
                                        <?php /*<select name="selling_currency" class="bootstrap-select  input-roundless" data-width="100px">
                                            <option value="<?php echo $current_client->base_currency; ?>"><?php echo $current_client->base_currency; ?></option>
                                        </select>*/ ?>
                                    </div>
                            ...
                            <div id="item_cost_info" class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon label-roundless">Rate:</span>
                                        <input type="text" name="billing_rate" value=""
                                               class="form-control input-roundless" placeholder="0.00">

                                        <span class="input-group-addon label-roundless no-border-left">{{$tenant->base_currency}}</span>
                                        <input type="hidden" name="billing_currency" value="{{$tenant->base_currency}}">

                                        <?php /*<select name="billing_currency" class="bootstrap-select  input-roundless" data-width="100px">
                                            <option value="<?php echo $current_client->base_currency; ?>"><?php echo $current_client->base_currency; ?></option>
                                        </select>*/ ?>
                                    </div>
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <textarea name="billing_description" class="form-control input-roundless"
                                              placeholder="Sales description" rows="3"></textarea>
